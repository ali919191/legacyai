...
- [Memory Grounded Responses](#memory-grounded-responses)
...
Every response generated by the Conversation Engine is synthesised **exclusively from stored memories**. No external knowledge is used and no hardcoded strings are returned.
